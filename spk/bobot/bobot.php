...
<div class="container my-4">
 ...
 <form action="bobot/aksi_ubah_bobot.php" method="POST">
   <div class="form-group row">
     <label for="staticEmail" class="col-sm-2 col-form-label">W1 (Nilai Tes Bahasa)</label>
     <div class="col-sm-10">
       <input type="text"  class="form-control" name="w1" value="<?php echo $row['w1'] ?>">
     </div>
   </div>
   <div class="form-group row">
     <label for="inputPassword" class="col-sm-2 col-form-label">W2 (Nilai Tes Matematika)</label>
     <div class="col-sm-10">
       <input type="text" class="form-control" name="w2" value="<?php echo $row['w2'] ?>">
     </div>
   </div>
   <div class="form-group row">
     <label for="inputPassword" class="col-sm-2 col-form-label">W3 (Nilai Tes Sejarah)</label>
     <div class="col-sm-10">
       <input type="text" class="form-control" name="w3" value="<?php echo $row['w3'] ?>">
     </div>
   </div>
   <div class="form-group row">
     <label for="inputPassword" class="col-sm-2 col-form-label">W4 (Psikotes)</label>
     <div class="col-sm-10">
